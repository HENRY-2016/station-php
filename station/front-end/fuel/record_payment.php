   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Fuel | Record Payment</label>
                  ...
                  <form id="my-form">
                     <div class="my-grid-container">
                        ...
                        <div class="my-grid-item">
                           ...
                           <input required type="text" class="form-control" required name="amount" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" placeholder="Amount"  autocomplete="off">
                        </div>
                        <!-- <div class="my-grid-item">
                           <label class="input-labels" >Date:</label>
                           <input required type="date" class="form-control" required name="reg_date" placeholder="Enter password"  autocomplete="off">
                        </div> -->
                        <div class="my-grid-item">
                        ...
                        <div class="my-grid-item" >
                           <label style="display:none" class="input-labels">staff Id:</label><br>
                        </div>
                        <div class="my-grid-item">
                           <button type="submit" onclick="submitFormData ('my-form',add_fuel_payment_url)" class="btn btn-primary submit-btn">Submit</button>
                        </div>
