...
{
   autocomplete(document.getElementById("ridder-name-input-id"), ridders_names_with_hide);    
...
{ 
   Load_Names_With_Hide(fuel_ridders_with_hide_api);Load_Stage_Names(ridders_stage_api);Load_Stage_Number_Plate(ridders_numberplate_api);
...
<body onload="Do_Logic ()" class="app-body">
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         ...
         <label class="page-title-label" >Fuel | Record Taken</label>
            <div id="feedback-popup" class="feedback-popup-window w3-dropdown-content  w3-card-4 w3-animate-zoom">
               ...
               <form id="my-form">
                     ...
                     <div class="my-grid-item">
								...
								<input required type="text" required class="form-control" name="ltrs" placeholder="Number Plate"  autocomplete="off">
							</div>
							<div class="my-grid-item">
								<label class="input-labels" >Amount:</label>
								<input required type="text" required class="form-control" name="amount" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" placeholder="Amount"  autocomplete="off">
							</div>
							<!-- <div class="my-grid-item">
								<label class="input-labels" >Date:</label>
								<input required type="date" required class="form-control" name="reg_date" placeholder="Enter password"  autocomplete="off">
							</div> -->
                        <!-- <div class="my-grid-item">
                     ...
                     <div class="my-grid-item">
                        <button type="submit" onclick="submitFormData ('my-form',add_fuel_url)" class="btn btn-primary submit-btn">Submit</button>
                     </div>
                     <div class="my-grid-item">
