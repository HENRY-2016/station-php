...
{
   display_Date ();
   ViewExpensesData (view_today_expense_url);
}
</script>
</head>
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Expenses | List </label>
               <div id="navi-links">
               ...
               <br>
                  ...
                  <script>
                     function ShowTodaysData ()
                        {ViewExpensesData (view_today_expense_url);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewExpensesData (view_all_expense_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewExpensesData (view_this_week_expense_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewExpensesData (view_this_month_expense_url);document.getElementById('options-modal').style.display='none';}
