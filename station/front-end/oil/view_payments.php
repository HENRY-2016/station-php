...
{Load_Names(names_ridders_api);Load_Staff_Names(names_staffs_api);Load_Staff_Ids(names_staffs_id_api);}

function Do_Logic ()
{
   display_Date ();
   ViewPaymentsData (view_today_oil_payments_url);
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Oil | View Payments</label>
            <div id="navi-links">
                  ...
                  <form id="my-form">
                     <div class="my-grid-container">
                        <div class="my-grid-item">
                           <label class="input-labels" >Rider's Name:</label>
                           <input type="text" class="form-control" name="ridder" placeholder="Rider's Name" autocomplete="off" >
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels">Number Plate:</label>
                           <input type="text" class="form-control" name="number_plate" maxlength="8" oninput=" this.value = this.value.toLocaleUpperCase()" placeholder="UBD 769T"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels"> Amount:</label>
                           <input type="text" class="form-control" name="amount" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" placeholder="Amount"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Date:</label>
                           <input type="date" class="form-control" name="reg_date" placeholder="Enter password"  autocomplete="off">
                        </div>
                        
                        <div class="my-grid-item">
                           <label class="input-labels" >Staff Name:</label>
                           <input type="text" class="form-control" name="staffname" placeholder="Staff Name:" name="email">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Staff  Id:</label><br>
                           <div class="autocomplete">
                              <input id="staff-id-input-id" type="text" class="form-control" name="staffid" placeholder="Staff Name:" name="email">
                           </div>
                        </div>
                        <div class="my-grid-item">
               ...
               <br>
                  ...
                  <script>
                     function ShowTodaysData ()
                        {ViewPaymentsData (view_today_oil_payments_url);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewPaymentsData (view_all_oil_payments_url );document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewPaymentsData (view_this_week_oil_payments_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewPaymentsData (view_this_month_oil_payments_url );document.getElementById('options-modal').style.display='none';}
