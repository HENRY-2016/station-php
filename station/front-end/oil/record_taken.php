...
{ 
   Load_Names_With_Hide(oil_ridders_with_hide_api);
   Load_Staff_Names(names_staffs_api);Load_Staff_Ids(names_staffs_id_api);

   // Load_Stage_Names_With_Name(ridders_stage_with_name_api);
   // Load_Stage_Number_Plate_With_Name(ridders_numberplate_with_name_api);
   
   Load_Stage_Names(ridders_stage_api);Load_Stage_Number_Plate(ridders_numberplate_api);
}
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Oil | Record Taken</label>
					...
					<form id="my-form">
                     ...
                     <div class="my-grid-item">
                        ...
                        <div class="autocomplete">
                           <input id="ridder-name-input-id" onblur="populateNumberPlateAndStage ()"  required type="text" class="form-control" name="ridder" placeholder="Rider's Name"  autocomplete="off">
                        </div>
							</div>
							<div class="my-grid-item">
                     ...
                     <div class="my-grid-item">
								...
								<input type="text" class="form-control" required name="ltrs" placeholder="ltrs"  autocomplete="off">
							</div>
							<div class="my-grid-item">
							...
							<!-- <div class="my-grid-item">
								...
								<input type="text" id="data-input" class="form-control" required name="reg_date" placeholder="Date"  autocomplete="off">
							</div> -->
                     <div class="my-grid-item">
