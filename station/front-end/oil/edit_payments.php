...
function Do_Logic ()
{
   ...
   ViewOilFuelPaymentsEditData  (view_today_oil_payments_url,edit_oil_payments_api,delete_oil_payments_api);
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Oil | Edit Payments</label>
            ...
            <a href="/station/front-end/oil/edit.php"><button type="button" class="btn btn-info">Edit Oil</button></a>
               <a href="/station/front-end/oil/payment.php"><button type="button" class="btn btn-info">Edit Payments</button></a>
               ...
               <div id="quick-links-div-2">
                  ...
                  <div id="update-div">
                     ...
                     <div class="my-grid-container">
                        ...
                        <div class="my-grid-item">
                           <button type="submit" onclick="submitFormData ('my-form',update_oil_payments_api)" class="btn btn-primary submit-btn">Submit</button>
                        </div>
               ...
               <br>
                  ...
                  <script>
                     function ShowTodaysData ()
                        {ViewOilFuelPaymentsEditData  (view_today_oil_payments_url,edit_oil_payments_api,delete_oil_payments_api);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewOilFuelPaymentsEditData  (view_all_oil_payments_url,edit_oil_payments_api,delete_oil_payments_api);document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewOilFuelPaymentsEditData  (view_this_week_oil_payments_url,edit_oil_payments_api,delete_oil_payments_api);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewOilFuelPaymentsEditData  (view_this_month_oil_payments_url,edit_oil_payments_api,delete_oil_payments_api);document.getElementById('options-modal').style.display='none';}
