...
{
   display_Date ();
   ViewStaffsEditData (view_staffs_url,edit_staff_api,delete_staff_api);
}
</script>
</head>
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Staff | Edit </label>
            ...
            <div id="quick-links-div-2">
               ...
               <form id="my-form">
                     <div class="my-grid-container">
                        ...
                        <div class="my-grid-item">
                           <label class="input-labels" >Staff Id:</label>
                           <input required type="text" id="staff-input-id" class="form-control" name="lname"  placeholder="Last Name"  autocomplete="off">
                        </div>
                        ...
                        <div class="my-grid-item">
                           <label class="input-labels"> Role:</label>
                           <input required type="text" id="role-input-id" class="form-control" name="role"  placeholder="Staff Role"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Contact:</label>
                           <input required type="text" id="contact-input-id" class="form-control" name="contact" placeholder="Contact"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Date:</label>
                           <input required type="date" id="date-input-id" name="reg_date" class="form-control"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Log In Name</label>
                           <input required type="text" id="username-input-id" name="reg_date" class="form-control"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Log In Password</label>
                           <input required type="text" id="password-input-id" placeholder="New Password" name="reg_date" class="form-control"  autocomplete="off">
                        </div>
                        <input type="text"  id="input-id" style="display:none"  required name="id" placeholder="id"  autocomplete="off">
                        
                        <div class="my-grid-item">
                           <button type="submit" onclick="submitFormData ('my-form',update_staffs_api)" class="btn btn-primary submit-btn">Submit</button>
                        </div>
                     </div>
                  </form>
               </div>
            ...
            <div class="w3-modal-content w3-animate-top w3-card-4">
                  <div class="w3-container first-pop-up-window">
                     ...
                     <form id="delete-form" ><br>
                        <center>
                              <label>Row To Delete</label><br>
                              <div class="autocomplete">
                                 <input id="delete-input-id" type="text" name="id" placeholder="Id" autocomplete="off" class="form-inputs">
                              </div><br>
         
                              <button type="submit"  onclick="DeleteFunction ('delete-form' , delete_oil_url)" class="btn btn-danger">Confirm</button>
                        </center>
                     </form>
                     <button onclick="document.getElementById('delete-modal').style.display='none'" type="button" class="close-popup-label" >Close</button><br>
                  </div>		
            </div>
         </div> -->
               ...
               <br>
                     ...
                     <div class="options-grid-item ">
                        ...
                        <form id="month-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitFormDataAndGet ('month-form',view_by_name_oil_url)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                     </div>
                  </div>
                  <script>
                     function ShowTodaysData ()
                        {ViewOilFuelData (view_today_oil_url);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewOilFuelData (view_all_oil_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewOilFuelData (view_this_week_oil_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewOilFuelData (view_this_month_oil_url);document.getElementById('options-modal').style.display='none';}
