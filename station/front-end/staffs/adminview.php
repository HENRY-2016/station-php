...
{
   display_Date ();
   ViewAdminEditData (view_admin_url,delete_admin_api);
}
</script>
</head>
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Admin | List </label>
            <div id="navi-links">
               ...
               <br>
                  ...
                  <script>
                     function ShowAllData ()
                        {ViewAdminEditData (view_admin_url);document.getElementById('options-modal').style.display='none';}
                  </script>
                  </center>
               <br><br>
