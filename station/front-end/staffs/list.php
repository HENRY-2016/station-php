   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Staff | List </label>
            <div id="navi-links">
               ...
               <br>
                     ...
                     <div class="options-grid-item ">
                        ...
                        <!-- <form id="range-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitFormDataAndGetStaffs ('range-form',view_range_oil_url)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                     </div> -->
                     ...
                     <div class="options-grid-item ">
                        ...
                        <form id="my-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitFormDataAndGetStaffs ('my-form',view_staffs_by_name_url)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                     </div>
                  </div>
                  <script>
                     function ShowTodaysData ()
                        {ViewStaffsData (view_today_oil_url);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewStaffsData (view_staffs_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewStaffsData (view_this_week_oil_url);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewStaffsData (view_this_month_oil_url);document.getElementById('options-modal').style.display='none';}
