   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Staff | Add </label>
                  ...
                  <form id="my-form">
                     <div class="my-grid-container">
                        ...
                        <div class="my-grid-item">
                           ...
                           <input required type="text" class="form-control" name="role"  placeholder="Staff Role"  autocomplete="off">
                        </div>

                        <div class="my-grid-item">
                           <label class="input-labels" >Contact:</label>
                           <input required type="text" class="form-control" name="contact" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" placeholder="Contact"   autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Date:</label>
                           <input required type="date"  name="reg_date" class="form-control"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                        ...
                        <div class="my-grid-item">
                           ...
                           <input required type="text" class="form-control" name="password" maxlength="8"  placeholder="Log In Password"   autocomplete="off">
                        </div>
                       
                        
                        <div class="my-grid-item">
                           <button type="submit" onclick="submitFormData ('my-form',create_staffs_url)" class="btn btn-primary submit-btn">Submit</button>
                        </div>
