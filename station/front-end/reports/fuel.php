...
{
   display_Date ();
   ViewOilFuelReportData (view_report_fuel_today_api);
...
<body onload=" Do_Logic ()" class="app-body">
   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         ...
         <label class="page-title-label" >Fuel | Report</label>
         <div id="navi-links">
               ...
               <br>
                     ...
                     <div class="options-grid-item ">
                        ...
                        <form id="range-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitReportFormDataAndGet ('range-form',view_report_fuel_range_api)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                     </div>
                     ...
                     <div class="options-grid-item ">
                        ...
                        <form id="my-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitReportFormDataAndGet ('my-form',view_report_fuel_name_api)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                        ...
                        <form id="stage-form">
                           <div class="view-by-name-div">
                              ...
                              <button type="submit" onclick="submitReportFormDataAndGet ('stage-form',view_report_fuel_stage_name_api)" class="btn btn-info range-view-btns">View</button>
                           </div>
                        </form>
                     </div>
                  </div>
                  <script>
                     function ShowTodaysData ()
                        {ViewOilFuelReportData (view_report_fuel_today_api);document.getElementById('options-modal').style.display='none';}
                     function ShowAllData ()
                        {ViewOilFuelReportData (view_report_fuel_all_api);document.getElementById('options-modal').style.display='none';}
                     function ShowThisWeekData ()
                        {ViewOilFuelReportData (view_report_fuel_this_week_api);document.getElementById('options-modal').style.display='none';}
                     function ShowThisMonthData ()
                        {ViewOilFuelReportData (view_report_fuel_this_month_api);document.getElementById('options-modal').style.display='none';}
                  </script>
                  </center>
               <br><br>
