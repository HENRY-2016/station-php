   ...
   <div id="wrapper">
      ...
      <div id="page-content-wrapper">
         <div class="container-fluid main-section-content">
            <label class="page-title-label" >Riders | Add </label>
                  ...
                  <form id="my-form">
                     <div class="my-grid-container">
                        ...
                        <div class="my-grid-item">
                           ...
                           <input required type="text" class="form-control" name="lname" placeholder="Last Name"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                        ...
                        <div class="my-grid-item">
                           ...
                           <input required type="text" class="form-control" maxlength="8" oninput=" this.value = this.value.toLocaleUpperCase()" name="number_plate" placeholder="UBD 769T"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Contact:</label>
                           <input required type="text" name="contact" class="form-control" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" placeholder="contact"  autocomplete="off">
                        </div>
                        <div  class="my-grid-item">
                           <label class="input-labels" >Stage Name:</label>
                           <input required type="text" required class="form-control" placeholder="Stage Name" name="stage"  autocomplete="off">
                        </div>
                        <div class="my-grid-item">
                           <label class="input-labels" >Date:</label>
                           <input required type="date" class="form-control" name="reg_date"  autocomplete="off">
                        </div>

                        <div class="my-grid-item">
                           <label style="display:none" class="input-labels" >Date:</label>
                        </div>
                        
                        <div class="my-grid-item">
                           <button type="submit" onclick="submitFormData ('my-form',create_ridder_url)" class="btn btn-primary submit-btn">Submit</button>
                        </div>
